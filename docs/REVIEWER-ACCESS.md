...
| `samples/scan.pdf` | Scanned multi-page document — exercises `compress_file`, `rotate_pdf`. |
...
4. "Compress ~/Downloads/scan.pdf to medium quality." — `compress_file`
5. "Split ~/Downloads/two-pager.pdf into one PDF per page." — `split_pdf`
6. "Delete page 2 from ~/Downloads/two-pager.pdf." — `delete_pdf_pages`
7. "Rotate all pages in ~/Downloads/scan.pdf 90 degrees clockwise." — `rotate_pdf`
8. "Flatten the form fields in ~/Downloads/form.pdf." — `flatten_pdf`
9. "Password-protect ~/Downloads/contract.pdf with the password 'review123'." — `protect_pdf`
10. "Remove the password 'review123' from the protected PDF." — `unprotect_pdf`
11. "Extract all text from ~/Downloads/contract.pdf." — `extract_pdf_text`
12. "Extract all tables from ~/Downloads/invoice.pdf as Excel." — `extract_pdf_tables`
13. "Extract the form fields from ~/Downloads/form.pdf." — `extract_pdf_forms`
14. "Find all PII in ~/Downloads/contract.pdf." — `extract_pii`
15. "Redact the PII you just found from ~/Downloads/contract.pdf." — `redact_pdf`
16. "Search for the word 'invoice' in ~/Downloads/invoice.pdf." — `search_text_in_pdf`
17. "Show me the metadata for ~/Downloads/invoice.pdf." — `get_pdf_metadata`
18. "Set the title of ~/Downloads/contract.pdf to 'Reviewer Test'." — `set_pdf_metadata`
...
- Tools write outputs as siblings of the input file with a non-clobbering suffix (`-merged`, `-compressed-medium`, etc.); they never overwrite the input.
