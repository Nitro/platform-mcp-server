...
function NitroPdfViewer() {
    ...
    if (error) {
        return (_jsxs("div", { className: "state-container", children: [_jsx("div", { className: "error-icon", children: "\u26A0" }), _jsx("p", { className: "state-text", children: error.message })] }));
    }
    if (!app || !pdfBytes) {
        return (_jsxs("div", { className: "state-container", children: [_jsx("div", { className: "spinner" }), _jsx("p", { className: "state-text", children: !app ? "Connecting…" : `Loading ${filename || "PDF"}…` })] }));
    }
    return (_jsxs("div", { className: "viewer-shell", children: [_jsxs("div", { className: "toolbar", children: [_jsx("div", { className: "toolbar-logo", children: _jsxs("svg", { width: "60", height: "23", viewBox: "0 0 80 31", fill: "none", children: [_jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.4553 20.5908L10.2649 17.7236V17.7241L10.0326 17.4928L10.0454 17.5864L10.0324 17.492L9.94914 16.8897L8.99678 10.0102C9.01094 10.0262 9.02627 10.0424 9.0406 10.0569L12.2312 12.9241V12.9234L12.4633 13.1547L12.4505 13.0614L12.4635 13.1557L12.547 13.758L13.4992 20.6374C13.485 20.6214 13.4698 20.6051 13.4553 20.5908ZM20.7613 2.24424L12.5923 0.0682754C11.4835 -0.226962 10.7082 0.463148 10.8662 1.60078L12.1089 10.5924L12.0591 10.5304L12.0471 10.5147L8.34083 6.52052C8.333 6.51169 8.327 6.50585 8.32133 6.49819C7.98361 6.08532 7.42829 6.12714 6.86464 6.69579L3.57104 10.0127C2.76264 10.8265 1.96606 12.4221 1.80195 13.5591L0.0221919 25.8008C-0.142588 26.9367 0.628328 28.1072 1.7348 28.4036L9.90365 30.5794C11.0125 30.8746 11.7877 30.1847 11.6298 29.0469L10.3868 20.0553L10.4368 20.1173L10.4488 20.1328L14.1551 24.127C14.1629 24.136 14.1689 24.1418 14.1746 24.1493C14.5123 24.5622 15.0676 24.5203 15.6315 23.9519L18.9249 20.6349C19.7333 19.821 20.5299 18.2254 20.694 17.0884L22.4737 4.84689C22.6385 3.71109 21.8676 2.54064 20.7613 2.24424Z", fill: "#F54811" }), _jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M36.5934 24.5823C36.555 24.851 36.3034 25.0702 36.0345 25.0702H33.2719C33.0028 25.0702 32.8147 24.851 32.8518 24.5823L34.2434 14.7073C34.2434 14.4838 34.1793 14.3155 34.0517 14.2032C33.9233 14.0914 33.8847 14.0872 33.8847 14.0872C33.6172 14.0588 33.179 14.0355 32.9095 14.0355H31.4516C31.1098 14.0355 30.7683 14.0616 30.4267 14.1133L30.0854 14.1646C29.8364 14.2214 29.6016 14.4873 29.5639 14.7563L28.1902 24.5823C28.1526 24.8508 27.9022 25.0702 27.6329 25.0702H24.8701C24.6024 25.0702 24.4126 24.8508 24.45 24.5823L26.2098 11.9128C26.2473 11.6448 26.4974 11.4252 26.7667 11.4252H29.1702C29.4387 11.4252 29.6587 11.6472 29.6587 11.9181V12.8209C30.0854 12.2693 30.6399 11.8995 31.3236 11.7097C32.0063 11.5201 33.3197 11.4511 33.3197 11.4511C33.5888 11.4369 34.0276 11.4252 34.2967 11.4252H35.0891C35.6862 11.4252 36.1808 11.4805 36.5739 11.5894C36.9664 11.6989 37.2792 11.8634 37.5089 12.0828C37.7396 12.3014 37.898 12.5755 37.9834 12.9036C38.0678 13.2323 38.0859 13.5861 38.0859 13.5861C38.0999 13.8572 38.0796 14.2977 38.0409 14.5661L36.5934 24.5823Z", fill: "white" }), _jsx("path", { fillRule: "evenodd", clipRule: "evenodd", d: "
.5222C73.9788 22.3833 74.3617 22.294 74.6696 22.118C74.9755 21.942 75.0764 21.6478 75.0764 21.6478C75.1637 21.3905 75.27 20.9612 75.312 20.6933L76.1852 15.0745C76.1852 14.4329 75.7192 14.1131 74.7881 14.1131ZM79.1366 20.8191C79.0134 21.6423 78.7813 22.3307 78.4382 22.8823C78.0955 23.4348 77.6645 23.8712 77.1466 24.1928C76.6286 24.5142 76.0263 24.7419 75.3414 24.8725C74.6558 25.0041 73.6295 25.0485 73.6295 25.0485C73.3534 25.0601 72.9013 25.0702 72.6244 25.0702H71.1498C70.3594 25.0702 69.6651 25.0122 69.0674 24.8972C68.4703 24.7819 67.9646 24.5846 67.5531 24.3041C67.1388 24.0241 66.8313 23.6451 66.63 23.1672C66.4271 22.6888 66.3632 21.8295 66.3632 21.8295C66.3434 21.559 66.3583 21.1179 66.3982 20.8499L67.1963 15.3805C67.3022 14.6547 67.5394 14.0416 67.9082 13.5391C68.2771 13.036 68.7294 12.6286 69.2655 12.3153C69.8022 12.0029 70.3945 11.7758 71.0449 11.6354C71.6941 11.4953 72.546 11.4515 72.546 11.4515C72.8217 11.4369 73.2746 11.4252 73.5509 11.4252H75.3153C75.9999 11.4252 76.6333 11.4868 77.2122 11.6103C77.7925 11.7342 78.2891 11.936 78.7021 12.216C79.1147 12.4964 79.4396 12.8638 79.677 13.3162C79.9147 13.7698 79.986 14.5183 79.986 14.5183C80.0121 14.7892 79.9993 15.2288 79.9575 15.4973L79.1366 20.8191Z", fill: "white" })] }) }), _jsx("div", { className: "toolbar-sep" }), _jsx("button", { className: "tb-btn", onClick: () => handleRotate(-90), title: "Rotate left", children: "\u21BA" }), _jsx("button", { className: "tb-btn", onClick: () => handleRotate(90), title: "Rotate right", children: "\u21BB" }), _jsx("div", { className: "toolbar-sep" }), _jsx("span", { className: "tb-info", children: totalPages > 0 ? `${totalPages} pages` : "" }), statusMsg && _jsx("span", { className: "tb-status", children: statusMsg }), _jsx("button", { className: "tb-save", onClick: handleSave, disabled: isSaving, children: isSaving ? "Saving…" : "Save" })] }), _jsx("div", { className: "pages-area", children: _jsx(PdfViewer, { pdfBytes: pdfBytes, rotations: rotations, currentPage: currentPage, zoom: zoom, onTotalPages: handleTotalPages }) }), _jsxs("div", { className: "bottombar", children: [_jsxs("div", { className: "bb-nav", children: [_jsx("button", { className: "bb-btn", disabled: currentPage <= 1, onClick: () => setCurrentPage(1), children: "\u23EE" }), _jsx("button", { className: "bb-btn", disabled: currentPage <= 1, onClick: () => setCurrentPage(p => p - 1), children: "\u25C0" }), _jsxs("span", { className: "bb-label", children: [currentPage, " / ", totalPages] }), _jsx("button", { className: "bb-btn", disabled: currentPage >= totalPages, onClick: () => setCurrentPage(p => p + 1), children: "\u25B6" }), _jsx("button", { className: "bb-btn", disabled: currentPage >= totalPages, onClick: () => setCurrentPage(totalPages), children: "\u23ED" })] }), _jsxs("div", { className: "bb-zoom", children: [_jsx("button", { className: "bb-btn", disabled: zoom <= 0.5, onClick: () => setZoom(z => Math.max(0.5, z - 0.25)), children: "\u2212" }), _jsxs("span", { className: "bb-label", children: [Math.round(zoom * 100), "%"] }), _jsx("button", { className: "bb-btn", disabled: zoom >= 3.0, onClick: () => setZoom(z => Math.min(3.0, z + 0.25)), children: "+" })] })] })] }));
}
createRoot(document.getElementById("root")).render(_jsx(NitroPdfViewer, {}));
